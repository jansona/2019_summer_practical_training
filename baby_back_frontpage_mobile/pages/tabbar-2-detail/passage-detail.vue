<template>
	<view class="content">
		...
		<view class="cu-bar foot input" :style="[{bottom:InputBottom+'px'}]">
			<input class="solid-bottom" placeholder="快发表评论吧~" :adjust-position="false" :focus="false" maxlength="300" cursor-spacing="10"
