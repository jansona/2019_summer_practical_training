	...
	<view>
		<form method="post">
			<view class="cu-form-group">
				...
				<input placeholder="请输入嫌疑人的姓名或小名" name="lostName"></input>
			</view>
			<view class="cu-form-group">
			...
			<view class="cu-form-group">
				...
				<input placeholder="请输入嫌疑人的年龄范围" name="age"></input>
			</view>
			<view class="cu-form-group">
			...
			<view class="cu-form-group align-start">
				...
				<textarea maxlength="-1" :disabled="modalName!=null" @input="featureInput" placeholder="请输入失踪人特征描述"></textarea>
			</view>
			<view class="cu-form-group align-start">
				<view class="title">发现经过</view>
				<textarea maxlength="-1" :disabled="modalName!=null" @input="FindInput" placeholder="请输入具体的发现经过"></textarea>
			</view>
			<view class="cu-form-group align-start">
