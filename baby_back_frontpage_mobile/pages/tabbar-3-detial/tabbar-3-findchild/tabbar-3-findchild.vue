    ...
    <view>
        <form method="post">
            ...
            <view class="cu-form-group" style="margin-top: 30upx;">
                ...
                <picker mode="date" :value="findChildForm.date" start="1910-09-01" end="2020-09-01" @change="LostDateChange">
                    <view class="picker">
                        {{findChildForm.date}}
                    </view>
                </picker>
            ...
            <view class="cu-form-group align-start">
                ...
                <textarea maxlength="-1" :disabled="modalName!=null" v-model="findChildForm.babyDescription"
                    placeholder="请输入失踪人特征描述"></textarea>
            </view>
            <view class="cu-form-group align-start">
                <view class="title">失踪经过</view>
                <textarea maxlength="-1" :disabled="modalName!=null" v-model="findChildForm.missDescription"
                    placeholder="请输入具体的失踪经过"></textarea>
            </view>
            <view class="cu-form-group align-start">
                <view class="title">其他信息</view>
                <textarea maxlength="-1" :disabled="modalName!=null" v-model="findChildForm.otherDescription"
                    placeholder="请输入其他的信息"></textarea>
            </view>
            <view class="cu-form-group align-start">
            ...
            <view class="cu-form-group">
                <view class="grid col-4 grid-square flex-sub">
                    <view class="bg-img" v-for="(item,index) in findChildForm.imgList" :key="index" @tap="ViewImage"
                        :data-url="findChildForm.imgList[index]">
