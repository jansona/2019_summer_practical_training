	...
	<view>
		<form method="post">
			<view class="cu-form-group">
				...
				<input placeholder="请输入失踪人姓名" name="lostName"></input>
			</view>
			<view class="cu-form-group">
			...
			<view class="cu-form-group">
				...
				<input placeholder="请输入失踪人籍贯" name="birthPlace"></input>
			</view>
			<view class="cu-form-group">
				<view class="title">现居地</view>
				<input placeholder="请输入失踪人现居地" name="livePlace"></input>
			</view>
			<view class="cu-form-group">
			...
			<view class="cu-form-group">
				...
				<input placeholder="请输入联系人与失踪人的关系" name="contactRelation"></input>
			</view>
			<view class="cu-form-group">
