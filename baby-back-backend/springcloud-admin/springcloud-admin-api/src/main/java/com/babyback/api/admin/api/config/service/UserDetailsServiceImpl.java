package com.babyback.api.admin.api.config.service;

import com.babyback.api.admin.api.config.SctUser;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        Result<SysUser> result = remoteUserService.infoTel(username);
    ...
    private UserDetails getUserDetails(Result<SysUser> result) {
        ...
        String name = user.getTel() != null ? user.getTel() : user.getEmail();
        return new SctUser(user.getId(), name, user.getPassword(), true, true, true, true, authorityList);
    }
}
