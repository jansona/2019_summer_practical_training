package com.babyback.api.admin.biz.config;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.babyback.api.admin.biz.controller"))
    ...
    private List<SecurityContext> securityContexts() {
        ...
        result.add(getContextByPath("^(?!OAuth).*$"));
        return result;
    }
